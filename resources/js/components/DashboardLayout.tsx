        ...
        <div className="min-h-screen flex flex-col">
            ...
            <div className="flex flex-1">
                ...
                >
                    ...
                    <SidebarItem title="Événements" path="/dashbord/eventList" icon={Calendar} isSidebarOpen={isSidebarOpen} currentUrl={url} exact />
                    <SidebarItem
                        title="Inscriptions"
                        path="/inscriptions"
                        icon={Users}
                ...
                {/* Content */}
                <main className="flex-1 ml-0 md:ml-64 px-4 py-6 bg-gray-50 min-h-screen">
                    {children}
                </main>
            </div>
        </div>
